...
def filtering_img(img_raw):
    ...
    img_median = filters.median(
                    img_raw, morphology.disk(5))
    '''
    #footprint = morphology.disk(1)
    #background_inverted = morphology.white_tophat(
                    #img_inverted, footprint)r
    print(img_raw.shape)

    background_inverted = rolling_ball(
                    img_inverted, radius = 100)
    img_filtered = img_median - background_inverted
    plt.imshow(background_inverted, cmap = 'gray')
    plt.show()
    '''
